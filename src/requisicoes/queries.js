...
const addReq = "INSER INTO public.requisicao (requisicao_id, tipo, dataabertura, datafechamento, status, textolivre, funcionario_cpf, cliente_id) VALUES ($1, $2, $3, $4, $5, $6, $7, NULL)";
