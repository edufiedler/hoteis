...
const excluiFunc = "DELETE FROM public.funcionario WHERE funcionario_cpf = $1";
const atualizarFunc = "UPDATE public.funcionario SET nom_pnome = $1, nom_snome = $2, sexo = $3, datanasc = $4, endereco = $5, salario = $6, tipodecontrato = $7 WHERE id = $8";
